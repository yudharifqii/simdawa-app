                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    if ($a->keterangan == 'Belum Diverifikasi') :
                                        ...
                                        <a href=" . base_url('pendaftaran/verifikasi/batal/' . $a->id) . " class='btn btn-danger btn-sm' onclick='return confirm(\"Ingin batalkan akun ini?\")'><i class='fa fa-ban'></i> Batalkan</a></td>";
                                    else :
